...
class LabelFile(object):
    ...
    def saveYoloOBBFormat(self, filename, shapes, imagePath, imageData, classList,
        ...
        for shape in shapes:
            ...
            writer.addBndBox(corners[0], corners[1], corners[2], corners[3], imageShape[0], imageShape[1], centre_x_y[0], centre_x_y[1], height, width, angle, label, difficult) # Tuan Anh
